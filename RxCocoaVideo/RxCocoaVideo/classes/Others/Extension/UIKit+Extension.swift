...
extension UITableView {
    /// 注册 cell 的方法
//    func ym_registerCell<C: UITableViewCell>(cell: C.Type) where C: RegisterCellFromNib {
////        if let nib = C.nib {
////                    register(nib, forCellReuseIdentifier: C.identifier) }
////        else { register(cell, forCellReuseIdentifier: C.identifier) }
//        if let nib = C.nib{
//            register(nib, forCellReuseIdentifier: C.identifier)
//        }else{
...
//    }
    func ym_dequeueReusableCell<C: UITableViewCell>(indexPath: IndexPath) -> C where C:RegisterCellFromNib{

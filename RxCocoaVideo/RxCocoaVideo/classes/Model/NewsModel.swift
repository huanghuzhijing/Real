...
struct NewsModel: HandyJSON {
    ...
    var collectionViewH: CGFloat {
        return Calculate.collectionViewHeight(image_list.count)
    }
    /// collectionView 宽度
    var collectionViewW: CGFloat {
        return Calculate.collectionViewWidth(image_list.count)
    }
    ...
    var contentH: CGFloat {
        return abstract.textHeight(fontSize: 18, width: screenWidth - 60) }
    var item_id: Int = 0
    var cell_flag: Int = 0
    ...
    var createTime: String { return publish_time.convertString() }
    ...
    var large_image_list = [ThumbImage]()
    var weixin_cover_image = [ThumbImage]()
